// Copyright(c) 2015-present, Gabi Melman, mguludag and spdlog1 contributors.
...
// Color location is determined by the sink log pattern like in the rest of spdlog1 sinks.
