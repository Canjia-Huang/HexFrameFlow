...
// logger->info("Some buffer {}", spdlog1::to_hex(v));
// char buf[128];
// logger->info("Some buffer {:X}", spdlog1::to_hex(std::begin(buf), std::end(buf)));
// logger->info("Some buffer {:X}", spdlog1::to_hex(std::begin(buf), std::end(buf), 16));
