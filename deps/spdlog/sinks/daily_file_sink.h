 ...
 * Usages:
 *    auto sink =
 * std::make_shared<spdlog1::sinks::daily_file_format_sink_mt>("myapp-%Y-%m-%d:%H:%M:%S.log", hour,
 * minute);" auto logger = spdlog1::daily_logger_format_mt("loggername, "myapp-%Y-%m-%d:%X.log",
 * hour,  minute)"
 *
 */
