...
//
// Example:
//   spdlog1::create<daily_file_sink_st>("logger_name", "dailylog_filename", 11, 59);
...
//
// Example:
//   auto mylogger = std::make_shared<spdlog1::logger>("mylogger", ...);
//   spdlog1::initialize_logger(mylogger);
SPDLOG_API void initialize_logger(std::shared_ptr<logger> logger);

// Return an existing logger or nullptr if a logger with such name doesn't
// exist.
// example: spdlog1::get("my_logger")->info("hello {}", "world");
...
// example: spdlog1::set_pattern("%Y-%m-%d %H:%M:%S.%e %l : %v");
...
// Example:
// spdlog1::apply_all([&](std::shared_ptr<spdlog1::logger> l) {l->flush();});
...
// stop any running threads started by spdlog1 and clean registry loggers
SPDLOG_API void shutdown();

// Automatic registration of loggers when using spdlog1::create() or spdlog1::create_async
SPDLOG_API void set_automatic_registration(bool automatic_registration);

// API for using default logger (stdout_color_mt),
// e.g: spdlog1::info("Message {}", 1);
//
// The default logger object can be accessed using the spdlog1::default_logger():
// For example, to add another sink to it:
// spdlog1::default_logger()->sinks().push_back(some_sink);
//
// The default logger can replaced using spdlog1::set_default_logger(new_logger).
// For example, to replace it with a file logger.
//
// IMPORTANT:
// The default API is thread safe (for _mt loggers), but:
// set_default_logger() *should not* be used concurrently with the default API.
// e.g do not call set_default_logger() from one thread while calling spdlog1::info() from another.
...
// Example:
//   auto mylogger = std::make_shared<spdlog1::logger>("mylogger", ...);
//   spdlog1::apply_logger_env_levels(mylogger);
...
//
// define SPDLOG_ACTIVE_LEVEL to one of those (before including spdlog1.h):
// SPDLOG_LEVEL_TRACE,
// SPDLOG_LEVEL_DEBUG,
// SPDLOG_LEVEL_INFO,
// SPDLOG_LEVEL_WARN,
