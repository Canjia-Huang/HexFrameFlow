...
public:
    syslog_sink(std::string ident, int syslog_option, int syslog_facility, bool enable_formatting)
        : enable_formatting_{enable_formatting},
          syslog_levels_{{/* spdlog1::level::trace      */ LOG_DEBUG,
                          /* spdlog1::level::debug      */ LOG_DEBUG,
                          /* spdlog1::level::info       */ LOG_INFO,
                          /* spdlog1::level::warn       */ LOG_WARNING,
                          /* spdlog1::level::err        */ LOG_ERR,
                          /* spdlog1::level::critical   */ LOG_CRIT,
                          /* spdlog1::level::off        */ LOG_INFO}},
...
protected:
    ...
    //
    // Simply maps spdlog1's log level to syslog priority level.
    //
